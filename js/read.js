                    ...
                    if(format==="1"){
                        $.ajax({
                            ...
                            if (data) {
                                ...
                                document.getElementById("hola").innerHTML= "Nothing to Display.";
                            }
                        });
                    }
                    else if(format==="2"){
                        $.ajax({
                            type: "POST",
                            url: "http://206.189.133.125/api/v1/simple-projection/project-present",
                            data:input
                        }).done(function (data) {
                            if (data) {
                                var txt="";
                        ...
                        $.ajax({
                            type: "POST",
                            url: "http://206.189.133.125/api/v1/simple-projection/project-absent",
                            data:input
                        }).done(function (data) {
                            if (data) {
                                var txt="";
                                ...
                                document.getElementById("hola").innerHTML= data.error;
                            }
                        });
                    }
                }
